...
def main(full_path_to_file):
    ...
    baseline = np.mean(force_plate[:baseline_length]) ### your code here ###
...
if __name__ == "__main__":
    ...
    path_to_data_folder = "/Users/ryanb/OneDrive/Desktop/School/Engineering/ENGR 315/ENGR315-sp2026-Beach/data/drop-jump/force-plate/"
